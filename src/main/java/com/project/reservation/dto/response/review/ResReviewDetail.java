...
public class ResReviewDetail {
    ...
    @Builder
    public ResReviewDetail(Long reviewId, String title, String nickName, String content, LocalDateTime createdDate, int views, int likes, boolean hasLiked, List<ResComment> comments) {
